            ...
            <div class="bg-white shadow-md rounded p-6">
                <form method="POST" action="{{ route('listings.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" required></textarea>
                    ...
                    <div class="flex justify-end">
                        <x-primary-button>{{ __('Publish Listing') }}</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
